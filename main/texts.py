...
NOTIFY_ABOUT_UPDATES_TEXT = {
    ...
    "tr": "Başlangıçta güncellemeleri kontrol et",
    "zh": "启动时检查更新",
    "ru": "Проверять обновления при запуске",
    "pl": "Sprawdzaj aktualizacje przy uruchomieniu",
    "uk": "Перевіряти оновлення під час запуску",
    "ja": "起動時にアップデートを確認",
    "ko": "시작 시 업데이트 확인",
    "hi": "स्टार्टअप पर अपडेट के लिए जाँच करें",
    "bn": "স্টার্টআপে আপডেটের জন্য চেক করুন",
    ...
    "ar": "تحقق من وجود تحديثات عند بدء التشغيل",
    "vi": "Kiểm tra cập nhật khi khởi động",
    "fa": "بررسی بروزرسانی‌ها در شروع",
    "id": "Periksa pembaruan saat startup",
    "ms": "Semak pembaruan semasa permulaan",
    "th": "ตรวจสอบการอัปเดตเมื่อเริ่มต้น",
    "ur": "اسٹارٹ اپ پر اپ ڈیٹس چیک کریں",
}
LANGUAGE_LABEL_TEXT = {
    "en": "Language",
    "es": "Idioma",
...
FONT_INFORMATION_TEXT = {
    "en": "*You can preview the changes while the log window is open.",
    "es": "*Puede previsualizar los cambios mientras la ventana de registro está abierta.",
    "tr": "*Log penceresi açıkken değişiklikleri önizleyebilirsiniz.",
    "zh": "*打开日志窗口时，可以预览更改。",
    "ru": "*Вы можете просмотреть изменения, пока окно журнала открыто.",
    "pl": "*Możesz podglądać zmiany, gdy okno dziennika jest otwarte.",
    "uk": "*Ви можете переглянути зміни, поки вікно журналу відкрите.",
    "ja": "*ログウィンドウが開いている間、変更をプレビューできます。",
    "ko": "*로그 창이 열려 있는 동안 변경 사항을 미리 볼 수 있습니다.",
    "hi": "*लॉग विंडो खुली रहने पर आप परिवर्तनों का पूर्वावलोकन कर सकते हैं।",
    "bn": "*লগ উইন্ডো খোলা থাকাকালীন আপনি পরিবর্তনগুলি দেখতে পারেন।",
    "it": "*Puoi visualizzare in anteprima le modifiche mentre la finestra di registro è aperta.",
    "fr": "*Vous pouvez prévisualiser les modifications pendant que la fenêtre de journal est ouverte.",
    "de": "*Sie können die Änderungen in der offenen Protokollfenster anzeigen.",
    "pt": "*Você pode visualizar as alterações enquanto a janela de log está aberta.",
    "ar": "*يمكنك معاينة التغييرات أثناء فتح نافذة السجل.",
    "vi": "*Bạn có thể xem trước các thay đổi khi cửa sổ nhật ký đang mở.",
    "fa": "*شما می‌توانید تغییرات را در حالی که پنجره لاگ باز است، پیش‌نمایش کنید.",
    "id": "*Anda dapat melihat perubahan saat jendela log terbuka.",
    "ms": "*Anda boleh melihat perubahan semasa tetingkap log terbuka.",
    "th": "*คุณสามารถดูตัวอย่างการเปลี่ยนแปลงในขณะที่หน้าต่างบันทึกเปิดอยู่。",
    "ur": "*آپ لاگ ونڈو کھلی ہونے پر تبدیلیوں کا پیش نظارہ کر سکتے ہیں。",
}
APPLY_TEXT = {
    "en": "Apply",
    "es": "Aplicar",
...
SELECT_BOTH_FILES = {
    "en": "Please select video/reference subtitle and subtitle file.",
    "es": "Por favor, seleccione video/subtítulo de referencia y archivo de subtítulos.",
    "tr": "Lütfen video/referans altyazı ve altyazı dosyasını seçin.",
    "zh": "请选择视频/参考字幕和字幕文件。",
    "ru": "Пожалуйста, выберите видео/справочный субтитр и файл субтитров.",
    "pl": "Proszę wybrać plik wideo/napisy referencyjne i plik napisów.",
    "uk": "Будь ласка, виберіть відео/довідкові субтитри і файл субтитрів.",
    "ja": "動画/参照字幕と字幕ファイルを選択してください。",
    "ko": "비디오/참조 자막 및 자막 파일을 선택하세요.",
    "hi": "कृपया वीडियो/संदर्भ उपशीर्षक और उपशीर्षक फ़ाइल चुनें।",
    "bn": "অনুগ্রহ করে ভিডিও/রেফারেন্স সাবটাইটেল এবং সাবটাইটেল ফাইল নির্বাচন করুন।",
    "it": "Seleziona video/sottotitolo di riferimento e file dei sottotitoli.",
    "fr": "Veuillez sélectionner la vidéo/sous-titre de référence et le fichier de sous-titres.",
    "de": "Bitte wählen Sie Video/Referenz-Untertitel und Untertiteldatei aus.",
    "pt": "Por favor, selecione o vídeo/legenda de referência e o arquivo de legenda.",
    "ar": "يرجى تحديد الفيديو/الترجمة المرجعية وملف الترجمة.",
    "vi": "Vui lòng chọn video/phụ đề tham chiếu và tập tin phụ đề.",
    "fa": "لطفاً فایل ویدیو/زیرنویس مرجع و فایل زیرنویس را انتخاب کنید.",
    "id": "Pilih video/subtitle referensi dan file subtitle.",
    "ms": "Sila pilih video/subtitle referensi dan fail subtitle.",
    "th": "โปรดเลือกไฟล์วิดีโอ/คำบรรยายอ้างอิงและไฟล์คำบรรยาย",
    "ur": "براہ مہربانی ویڈیو/ریفرنس زیرنویس اور زیرنویس فائل منتخب کریں۔",
}
...
BATCH_SYNC_CANCEL_CONFIRMATION = {
    ...
    "uk": "Ви впевнені, що хочете скасувати пакетну синхронізацію?",
    "ja": "バッチ同期をキャンセルしてもよろしいですか？",
    "ko": "배치 동기화를 취소하시겠습니까?",
    "hi": "क्या आप सुनिश्चित हैं कि आप बैच सिंक्रनाइज़ेशन रद्द करना चाहते हैं?",
    "bn": "আপনি কি নিশ্চিত যে আপনি ব্যাচ সিঙ্ক্রোনাইজেশন বাতিল করতে চান?",
    "it": "Sei sicuro di voler annullare la sincronizzazione batch?",
    "fr": "Êtes-vous sûr de vouloir annuler la synchronisation par lot?",
    ...
    "vi": "Bạn có chắc chắn muốn hủy đồng bộ lô không?",
    "fa": "آیا مطمئن هستید که می خواهید همگام سازی دسته ای را لغو کنید؟",
    "id": "Apakah Anda yakin ingin membatalkan sinkronisasi batch?",
    "ms": "Adakah anda pasti ingin membatalkan penyegerakan batch?",
    "th": "คุณแน่ใจหรือไม่ว่าต้องการยกเลิกการซิงค์ชุดงาน",
    "ur": "کیا آپ کو یقین ہے کہ آپ بیچ ہم آہنگی منسوخ کرنا چاہتے ہیں؟",
}
AUTO_SYNC_CANCELLED = {
