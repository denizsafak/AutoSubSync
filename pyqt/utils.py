...
def match_subtitle_encoding(input_subtitle_path, output_subtitle_path, log_window=None, target_encoding=None):
    """
    ...
    try:
        ...
        if not os.path.exists(input_subtitle_path) or not os.path.exists(output_subtitle_path):
        ...
        try:
            ...
            with open(output_subtitle_path, 'r', encoding='utf-8', errors='replace') as f:
                content = f.read()
