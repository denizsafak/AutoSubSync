...
FFMPEG_GITHUB_URL = (
    "https://github.com/davepagurek/ffmpeg-static/releases/latest/download"
)
...
def get_zip_name(bin_name):
    ...
    os_arch_map = {
        ...
        "darwin": {
            "arm64": f"{bin_name}-darwin-arm64.gz",
            "amd64": f"{bin_name}-darwin-x64.gz",
        },
        "linux": {
            "amd64": f"{bin_name}-linux-x64.gz",
            "arm64": f"{bin_name}-linux-arm64.gz",
        },
    }
